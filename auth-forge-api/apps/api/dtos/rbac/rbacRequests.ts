...
export type CheckPermissionRequest = Request<{}, {}, {}, CheckPermissionRequestQuery>;

interface GrantPermissionRequestBody {
    userId: string;
    permission: string;
}
export type GrantPermissionRequest = Request<{}, {}, GrantPermissionRequestBody>;

interface RevokePermissionRequestBody {
    userId: string;
    permission: string;
}
export type RevokePermissionRequest = Request<{}, {}, RevokePermissionRequestBody>;

interface GetUserPermissionsRequestParams {
    userId: string;
}
export type GetUserPermissionsRequest = Request<GetUserPermissionsRequestParams>;
...
export type DeletePermissionRequest = Request<{}, {}, DeletePermissionRequestBody>;
