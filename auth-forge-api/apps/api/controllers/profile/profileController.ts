...
export class ProfileController {
    ...
    static async resetPassword(req: ResetPasswordRequest, res: Response<ResetPasswordResponse>) {
        try {
    ...
    static async getUser(req: GetUserRequest, res: Response<GetAccountResponse>): Promise<void> {
        try {
            const userId = req.user?.id;
