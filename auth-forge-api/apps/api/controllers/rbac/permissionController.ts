...
export class PermissionController {
    static async check(req: CheckPermissionRequest, res: Response<CheckPermissionResponse>) {
        try {
    ...
    static async grant(req: GrantPermissionRequest, res: Response<GrantPermissionResponse>) {
        try {
    ...
    static async revoke(req: RevokePermissionRequest, res: Response<RevokePermissionResponse>) {
        try {
            const { userId, permission } = req.body;
    ...
    static async getUserPermissions(req: GetUserPermissionsRequest, res: Response<GetUserPermissionsResponse>) {
        try {
    ...
    static async addPermission(req: AddPermissionRequest, res: Response<AddPermissionResponse>) {
        try {
            const { name } = req.body;
    ...
    static async deletePermission(req: DeletePermissionRequest, res: Response<DeletePermissionResponse>) {
        try {
            const { name } = req.body;
